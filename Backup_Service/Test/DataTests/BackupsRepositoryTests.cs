...
public class BackupsRepositoryTests
{
    [TestCase("1")]
    [TestCase("2")]
    public async Task BackupRepository_GetByIdAsync_ReturnsValue(string id)
    {
        // arrange
    ...
    [Test]
    public async Task BackupRepository_GetAllAsync_ReturnsAllValues()
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
        var userRepository = new UserRepository(context);
    ...
    [Test]
    public async Task BackupRepository_AddAsync_AddsValueToDatabase()
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
        var userRepository = new UserRepository(context);
    ...
    [Test]
    public async Task BackupRepository_UpdateAsync_ValueUpdated()
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
        var userRepository = new UserRepository(context);
    ...
    [TestCase("1")]
    [TestCase("2")]
    public async Task BackupRepository_DeleteAsync_ObjectIsDeleted(string id)
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
