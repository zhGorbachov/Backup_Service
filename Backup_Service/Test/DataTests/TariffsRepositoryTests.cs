...
public class TariffsRepositoryTests
{
    [TestCase("1")]
    [TestCase("2")]
    public async Task TariffRepository_GetByIdAsync_ReturnsValue(string id)
    {
        // arrange
    ...
    [Test]
    public async Task TariffRepository_GetAllAsync_ReturnsAllValues()
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
        var userRepository = new UserRepository(context);
    ...
    [Test]
    public async Task TariffRepository_AddAsync_AddsValueToDatabase()
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
        var userRepository = new UserRepository(context);
    ...
    [Test]
    public async Task TariffRepository_UpdateAsync_ValueUpdated()
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
        var userRepository = new UserRepository(context);
    ...
    [TestCase("2")]
    [TestCase("3")]
    public async Task TariffRepository_DeleteAsync_ObjectIsDeleted(string id)
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
