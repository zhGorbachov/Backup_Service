...
public class StoragesRepositoryTests
{
    [TestCase("1")]
    [TestCase("2")]
    [TestCase("3")]
    [TestCase("4")]
    public async Task StorageRepository_GetByIdAsync_ReturnsValue(string id)
    {
        // arrange
    ...
    [Test]
    public async Task StorageRepository_GetAllAsync_ReturnsAllValues()
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
        var userRepository = new UserRepository(context);
    ...
    [Test]
    public async Task StorageRepository_AddAsync_AddsValueToDatabase()
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
        var userRepository = new UserRepository(context);
    ...
    [Test]
    public async Task StorageRepository_UpdateAsync_ValueUpdated()
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
        var userRepository = new UserRepository(context);
    ...
    [TestCase("1")]
    [TestCase("2")]
    public async Task StorageRepository_DeleteAsync_ObjectIsDeleted(string id)
    {
        using var context = new BackupContext(UnitTestHelper.GetUnitTestsDbOptions());
